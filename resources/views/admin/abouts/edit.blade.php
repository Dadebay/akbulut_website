        ...
        <section class="content-header">
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-12">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">edit about us text</li>
                  </ol>
                </div>
              </div>
            </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="{{ route('abouts.update', $about->id) }}" novalidate>
                    @csrf
                    @method('patch')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="body-{{$localeCode}}" class="form-control {{ $errors->has('body_.' . $localeCode) ? ' is-invalid' : '' }}" name="body_{{ $localeCode }}" value="{{ old('body_.' . $localeCode) }}" required autocomplete="off">{{$about->getBodyTransArr($localeCode)}}</textarea>
