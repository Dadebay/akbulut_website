        ...
        <section class="content-header">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="{{ route('news.store') }}" enctype="multipart/form-data" novalidate>
                    @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name-{{ $localeCode }}"
                               ...
                               name="name_{{ $localeCode }}" value="{{ old('name.' . $localeCode) }}" required autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="bodypart-{{$localeCode}}" class="form-control {{ $errors->has('body_.' . $localeCode) ? ' is-invalid' : '' }}" name="body_{{ $localeCode }}" value="{{ old('body_.' . $localeCode) }}" required autocomplete="off">{{ old('body_.' . $localeCode) }}</textarea>
                               <span class="invalid-feedback" role="alert"><strong>Adyny hökman girizmeli</strong></span>
                    </div>
                    @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 my-2 d-flex">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="main" id="inlineRadio1" value="1" required>
                                <label class="form-check-label" for="inlineRadio1">True</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="main" id="inlineRadio2" value="0" checked>
