              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-12">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">edit privacy policy text</li>
                  </ol>
                </div>
              </div>
            </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h4 class="card-title">täze privacy policy text</h4>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="{{ route('privacies.update', $privacy->id) }}" novalidate>
                    @csrf
                    @method('patch')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="body-{{$localeCode}}" class="form-control {{ $errors->has('body_.' . $localeCode) ? ' is-invalid' : '' }}" name="body_{{ $localeCode }}" value="{{ old('body_.' . $localeCode) }}" required autocomplete="off">{{$privacy->getBodyTransArr($localeCode)}}</textarea>
